...
function checkNriHufSingleParentPartialCalculations() {
  ...
  assertIncludes(foreignEquityNoSalaryHtml, "Enter your salary income above to see a foreign tax credit estimate");
  ...
  if (foreignEquityWithSalaryHtml.includes("Enter your salary income above to see a foreign tax credit estimate")) {
