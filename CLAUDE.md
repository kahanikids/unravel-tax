...
- Format parsing follows Section 3 of docs/BUILD_PLAN.md exactly: CSV, Excel,
  ...
  LLM Options flow (in-browser Llama, OpenRouter, or copy-paste prompt).
  Do not build a bespoke PDF table parser — that's a deliberate decision,
...
- Tax rates/thresholds/rules live in rules/_.json, versioned by financial
  year, paired with rules/_.md for humans. Application code reads the
...
Update the relevant rules/_.json and rules/_.md together, bump the
